...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
			<br><br>
			<a class="btn btn-default pull-right" href="?language=es"> Spanish </a>
				<a class="btn btn-default pull-right" href="?language=en"> English </a> 
		...
		<form:form commandName="exercise">
			...
			<a class="btn btn-default" href="getGoalReports.html"> See all
				goals </a>
		</form:form>
